...
namespace ERPAPP.Repository
{
            ...
            return new List<MailListDto>
    {
        ...
        private string CustomerBlockBuildBody(string customerName, string customerCode)
        {
            ...
            body.Append("The #CustomerName# ( #CustomerCode# ) customer has been successfully unblocked. ").Replace("#CustomerName#", customerName).Replace("#CustomerCode#", customerCode);
            ...
            return new List<MailListDto>
    {
        ...
        private string VendorBlockBuildBody(string vendorCode, string vendorName)
        {
            ...
            body.Append("The #VendorName# ( #VendorCode# ) vendor has been successfully unblocked. ").Replace("#VendorName#", vendorName).Replace("#VendorCode#", vendorCode);
            body.Append("Please verify the same in D365 (Navision).<br/><br/>");
